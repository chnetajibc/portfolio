  ...
  return (
    <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogContent className="max-w-2xl w-[92vw] max-h-[80vh] p-0 gap-0 flex flex-col bg-white dark:bg-neutral-950 border-neutral-200 dark:border-neutral-800">
        <div className="shrink-0 px-6 pt-6 pb-4 border-b border-neutral-200 dark:border-neutral-800 bg-gradient-to-br from-white to-blue-50/40 dark:from-neutral-900 dark:to-blue-950/30 rounded-t-lg">
          <DialogHeader>
            <div className="flex items-center gap-3 text-left">
              ...
              <div>
                <DialogTitle className="font-display text-2xl text-blue-700 dark:text-blue-400">About this site</DialogTitle>
                <DialogDescription className="text-[13px] text-neutral-500 dark:text-neutral-400 mt-0.5">
        ...
        <div className="flex-1 overflow-y-auto thin-scroll px-6 py-5 space-y-4 min-h-0">
          {points.map(({ Icon, title, body }) => (
            <div key={title} className="flex items-start gap-3">
              ...
              <div>
                <div className="font-display font-semibold text-[14.5px] text-neutral-900 dark:text-neutral-50">{title}</div>
                <p className="text-[13px] text-neutral-600 dark:text-neutral-400 mt-0.5 leading-relaxed">{body}</p>
              </div>
            </div>
          ))}
          <div className="pt-2 border-t border-neutral-200 dark:border-neutral-800 mt-4 text-[12px] text-neutral-500 dark:text-neutral-500 leading-relaxed">
